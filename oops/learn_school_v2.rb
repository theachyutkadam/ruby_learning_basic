...
# school.add_classroom(classroom2) => [#<Classroom:0x000000022f3760 @name="beginners", @student=[]>, #<Classroom:0x000000026f9fa8 @name="graduation", @student=[]>]
...
# classroom1.add_student(student2) => [#<Student:0x00000002671d60 @name="achyut", @age=23, @birthdate="1996-07-02">, #<Student:0x00000002653bd0 @name="surya", @age=27, @birthdate="1991-05-16">]
# classroom2.add_student(student3) => [#<Student:0x0000000263e870 @name="satish", @age=20, @birthdate="1999-07-01">]

# school => #<School:0x00000002315f90 @name="ruby", @classrooms=[#<Classroom:0x000000022f3760 @name="beginners", @student=[#<Student:0x00000002671d60 @name="achyut", @age=23, @birthdate="1996-07-02">, #<Student:0x00000002653bd0 @name="surya", @age=27, @birthdate="1991-05-16">]>, #<Classroom:0x000000026f9fa8 @name="graduation", @student=[#<Student:0x0000000263e870 @name="satish", @age=20, @birthdate="1999-07-01">]>]>
# classroom1 => Classroom:0x000000022f3760 @name="beginners", @student=[#<Student:0x00000002671d60 @name="achyut", @age=23, @birthdate="1996-07-02">, #<Student:0x00000002653bd0 @name="surya", @age=27, @birthdate="1991-05-16">]>
